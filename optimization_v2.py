...
def main():
    ...
    n_iterations = 350 # Number of optimization iterations
    ...
    np.save(f"{time_str}_OptimizedTrajectory/bestpoints.npy", custom_points_best)
    ...
    optimization_info = {
        ...
        "n_points": num_points,
        "custom_points_best": custom_points_best,
    ...
    with open(f"{time_str}_OptimizedTrajectory/optimization_info.json", "w") as json_file:
